...
//
//   $ go get -d github.com/tonychanczm/mobile/example/basic
//   $ gomobile build github.com/tonychanczm/mobile/example/basic # will build an APK
//
//   # plug your Android device to your computer or start an Android emulator.
//   # if you have adb installed on your machine, use gomobile install to
//   # build and deploy the APK to an Android target.
//   $ gomobile install github.com/tonychanczm/mobile/example/basic
//
// Switch to your device or emulator to start the Basic application from
// the launcher.
// You can also run the application on your desktop by running the command
// below. (Note: It currently doesn't work on Windows.)
//   $ go install github.com/tonychanczm/mobile/example/basic && basic
package main
...
import (
	...
	"github.com/tonychanczm/mobile/exp/app/debug"
	"github.com/tonychanczm/mobile/exp/f32"
	"github.com/tonychanczm/mobile/exp/gl/glutil"
