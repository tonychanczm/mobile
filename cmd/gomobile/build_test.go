...
func TestAndroidBuild(t *testing.T) {
	...
	cmdBuild.flag.Parse([]string{"github.com/tonychanczm/mobile/example/basic"})
	oldTags := buildTags
...
func TestRegexImportGolangXPackage(t *testing.T) {
	tests := []struct {
		...
		{"ffffffff t github.com/tonychanczm/mobile", "github.com/tonychanczm/mobile", 2},
		{"ffffffff t github.com/example/repo/vendor/github.com/tonychanczm/mobile", "github.com/tonychanczm/mobile", 2},
		{"ffffffff t github.com/example/github.com/tonychanczm/mobile", "", 0},
	...
	for _, target := range []string{"android", "ios"} {
		t.Run(target, func(t *testing.T) {
			...
			tests := []struct {
				...
				{
					Name: "Absolute Path",
					Path: "github.com/tonychanczm/mobile/example/basic",
				},
				{
					Name: "Relative Path",
					Path: "./example/basic",
